...
let RewardsController = class RewardsController {
    ...
    async getLedger(user, page, limit) {
        return this.rewardsService.getLedger(user.id, page ? parseInt(page) : 1, limit ? parseInt(limit) : 20);
    }
};
...
], RewardsController.prototype, "getBalance", null);
__decorate([
