...
let SubscriptionsController = class SubscriptionsController {
    ...
    async skipNext(user, id) {
        return this.subscriptionsService.skipNext(user.id, id);
    }
    async editUpcomingKit(user, id, kitTemplateId) {
...
__decorate([
    (0, common_1.Patch)(':id/skip-next'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], SubscriptionsController.prototype, "skipNext", null);
__decorate([
    (0, common_1.Patch)(':id/edit-upcoming-kit'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __param(2, (0, common_1.Body)('kitTemplateId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, String]),
    __metadata("design:returntype", Promise)
], SubscriptionsController.prototype, "editUpcomingKit", null);
